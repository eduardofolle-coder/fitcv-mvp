      ...
      <section className="aw-card" style={{ marginBottom: 24 }}>
        ...
        {health && (
          <p className="aw-muted" style={{ marginBottom: 12 }}>
            Últimos {health.rule.days} días. Un portal se pausa para todos los candidatos solo si hay evidencia clara de que
            está técnicamente roto (el lector ya no encuentra el formulario) — nunca por CAPTCHA o login, eso se resuelve
            avisando solo al candidato que lo topó, sin afectar a los demás. La cola prioriza calce × salida limpia.
            "Pausar" a mano queda para casos que la estadística todavía no ve.
          </p>
        )}
