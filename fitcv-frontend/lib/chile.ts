export const NATIONALITIES = [
  'Chilena', 'Argentina', 'Peruana', 'Boliviana', 'Venezolana', 'Colombiana',
  'Ecuatoriana', 'Brasileña', 'Española', 'Mexicana', 'Uruguaya', 'Paraguaya',
  'Cubana', 'Haitiana', 'China', 'Estadounidense', 'Italiana', 'Francesa',
  'Alemana', 'Otra',
];

export interface Region {
  nombre: string;
  /** Código que usa el servidor para "¿Dónde quieres trabajar?". */
  codigo: string;
  comunas: string[];
}
...
export function comunasByRegion(regionNombre: string): string[] {
  return REGIONES.find(r => r.nombre === regionNombre)?.comunas ?? [];
}
